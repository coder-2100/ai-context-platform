...
describe("addPackageToLockfile", () => {
  it("添加包条目", () => {
    ...
    const updated = addPackageToLockfile(lockfile, {
      ...
      version: "1.0.0",
      resolved:
        "https://registry.npmjs.org/@coder-2100/core-engineering/-/core-engineering-1.0.0.tgz",
      integrity: "sha512-abc123",
    });
    expect(updated.packages["@coder-2100/core-engineering"]).toBeDefined();
    expect(updated.packages["@coder-2100/core-engineering"].version).toBe(
      "1.0.0",
    );
  });
  ...
  it("覆盖同名包", () => {
    ...
    expect(lockfile.packages["@coder-2100/core-engineering"].version).toBe(
      "1.1.0",
    );
  });
});
...
describe("removePackageFromLockfile", () => {
  it("移除存在的包", () => {
    ...
    const updated = removePackageFromLockfile(
      lockfile,
...
describe("saveLockfile + loadLockfile", () => {
  it("保存并加载 lock.yaml", () => {
    ...
    expect(loaded.packages["@coder-2100/core-engineering"].version).toBe(
      "1.0.0",
    );
  });
});
